...
public class Example_1_DataProvider {
    WebDriver driver;
    @BeforeMethod
    public  void setUp(){
    ...
    public void addEmployee(String firstname,String lastname) throws InterruptedException, IOException {
        ...
        FileInputStream fis=new FileInputStream("/Users/Eda/TestNG_iq/src/test/java/testNGsuite/loginCredential.properties");  // bilgiyi cek demek
        prop.load(fis);  // bilgiyi fis den yukle
        String userName=prop.getProperty("userName");  // bilgiyi nasil okutacaz parametrelerle ve bilgiti properties file dan depola demek
